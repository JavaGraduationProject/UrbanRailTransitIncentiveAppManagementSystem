  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" label="任务状态" prop="renwuzhuangtai">
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.renwushipin" label="任务视频" prop="renwushipin">
          <file-upload
          tip="点击上传任务视频"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.renwushipin?ruleForm.renwushipin:''"
          @change="renwushipinUploadChange"
          ></file-upload>
        </el-form-item> 
        <div v-else>
          <el-form-item v-if="ruleForm.renwushipin" label="任务视频" prop="renwushipin">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.renwushipin)">预览</el-button>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.renwuzhuangtai = true;
          ...
          if(o=='renwushipin'){
            this.ruleForm.renwushipin = obj[o];
	    this.ro.renwushipin = true;
            continue;
          }
          if(o=='renwuneirong'){
      ...
      this.$http({
		...
		if(json.fabuzhanghao!=''&&json.fabuzhanghao){
          ...
          this.$message.error(data.msg);
            ...
            this.renwuzhuangtaiOptions = "已接取,待接取".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
	...
	this.ruleForm.renwuneirong = this.ruleForm.renwuneirong.replace(reg,'../../../ssmzw8q6/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.renwushipin!=null) {
		this.ruleForm.renwushipin = this.ruleForm.renwushipin.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    renwushipinUploadChange(fileUrls) {
	this.ruleForm.renwushipin = fileUrls;
	this.addEditUploadStyleChange()
    },
